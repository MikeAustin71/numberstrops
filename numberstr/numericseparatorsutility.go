...
// setIntSepsDetail - Overwrites all the member variable data values
// for the input parameter 'numSeps' with numeric separator values
...
//     numericSeparatorsMechanics.setWithComponents()
//
// This method differs from numericSeparatorsUtility.setIntSepsDetailRunes()
...
//
// This method will overwrite all pre-existing data values in the
// in the input parameter 'numSeps'.
//
//
// ----------------------------------------------------------------
//
...
//       error message.
//
func (numSepsUtility *numericSeparatorsUtility) setIntSepsDetail(
	numSeps *NumericSeparators,
	decimalSeparators string,
	integerDigitsSeparators string,
	intSeparatorGrouping uint,
	...
	integerSeparatorsDto,
		err =
		NumStrIntSeparatorsDto{}.NewDetail(
			integerDigitsSeparators,
...
// setIntSepsDetailRunes - Overwrites all the member variable data
// values for the input parameter 'numSeps' with numeric separator
// values generated from the input parameters listed below.
//
// The resulting NumericSeparators values represent a basic numeric
// separators object with a three digit integer grouping sequence.
// This means that integer digits will be separated into
...
//     numericSeparatorsMechanics.setWithComponents()
//
// This method differs from numericSeparatorsUtility.setIntSepsDetail()
// in that this method accepts an array of runes for input parameters
// 'decimalSeparators' and 'integerDigitsSeparators'.
//
// IMPORTANT
//
...
//       error message.
//
func (numSepsUtility *numericSeparatorsUtility) setIntSepsDetailRunes(
	numSeps *NumericSeparators,
	decimalSeparators []rune,
	integerDigitsSeparators []rune,
	intSeparatorGrouping uint,
	...
	integerSeparatorsDto,
		err =
		NumStrIntSeparatorsDto{}.NewDetailRunes(
			integerDigitsSeparators,
			intSeparatorGrouping,
			intSeparatorRepetitions,
			ePrefix.XCtx(
