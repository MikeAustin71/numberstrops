...
// data elements in the current FormatterBinary instance.
//
// If the INumStrFormatter object is not of type FormatterBinary,
...
//  incomingIFormatter  INumStrFormatter
//     - This method will compare all data elements in the current
//       FormatterBinary instance to corresponding data elements
...
//       will be returned.
//
func (fmtBinary *FormatterBinary) EqualINumStrFormatter(
	incomingIFormatter INumStrFormatter,
	ePrefix *ErrPrefixDto) (
	isEqual bool,
	err error) {
	...
	var incomingFormatterBinary *FormatterBinary

	incomingFormatterBinary,
		isEqual = incomingIFormatter.(*FormatterBinary)
	...
	isEqual,
		err = formatterBinaryAtom{}.ptr().equal(
		fmtBinary,
		incomingFormatterBinary,
		ePrefix.XCtx(
			"incomingFormatterBinary vs "+
				"fmtBinary"))
