...
// data elements in the current FormatterCurrency instance.
//
// If the INumStrFormatter object is not of type FormatterCurrency,
...
//       will be returned.
//
func (fmtCurr *FormatterCurrency) EqualINumStrFormatter(
	incomingIFormatter INumStrFormatter,
	ePrefix *ErrPrefixDto) (
	isEqual bool,
	err error) {
...
//       error message.
//
func (fmtCurr *FormatterCurrency) GetFmtNumStr(
	absValIntegerRunes []rune,
	absValFractionalRunes []rune,
	signVal int,
	baseNumSys BaseNumberSystemType,
	...
	fmtNumStr += string(absValIntegerRunes) +
		string(fmtCurr.numericSeparators.decimalSeparators) +
...
// FormatterCurrency.
//
// If either the FormatterCurrency or NumericSeparators object is
// judged to be invalid, this method will return an error.
//
//
// ----------------------------------------------------------------
...
//       error message.
//
func (fmtCurr FormatterCurrency) NewDetail(
	decimalSeparatorChars string,
	integerDigitsSeparators string,
	intSeparatorGrouping uint,
	intSeparatorRepetitions uint,
...
// below.
//
// This method differs from method FormatterCurrency.NewDetail()
// in that this method accepts rune arrays for input parameters,
// 'decimalSeparatorChars' and 'integerDigitsSeparators'.
//
// To exercise granular control over all parameters needed to
...
//       error message.
//
func (fmtCurr FormatterCurrency) NewDetailRunes(
	decimalSeparatorChars []rune,
	integerDigitsSeparators []rune,
	intSeparatorGrouping uint,
	intSeparatorRepetitions uint,
...
//       error message.
//
func (fmtCurr *FormatterCurrency) SetDetail(
	decimalSeparatorChars string,
	integerDigitsSeparators string,
	intSeparatorGrouping uint,
	intSeparatorRepetitions uint,
...
//
// This method differs from method FormatterCurrency.SetDetail()
// in that this method accepts rune arrays for input parameters,
// 'decimalSeparatorChars' and 'integerDigitsSeparators'.
//
// To exercise granular control over all parameters needed to
...
//       error message.
//
func (fmtCurr *FormatterCurrency) SetDetailRunes(
	decimalSeparatorChars []rune,
	integerDigitsSeparators []rune,
	intSeparatorGrouping uint,
	intSeparatorRepetitions uint,
