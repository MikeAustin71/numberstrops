...
//       FormatterOctal instance to all corresponding data
//       elements in this second FormatterOctal object to
...
//
//  bool
//     - If all the data elements in the current FormatterOctal
//       instance are equal to all corresponding data elements in
//       'fmtOctalTwo', this return parameter will be set to
...
//       will be returned.
//
func (fmtOctal *FormatterOctal) Equal(
	fmtOctalTwo FormatterOctal,
	ePrefix *ErrPrefixDto) (
	bool,
	error) {
...
// data elements in the current FormatterOctal instance.
//
// If the INumStrFormatter object is not of type FormatterOctal,
...
//  incomingIFormatter  INumStrFormatter
//     - This method will compare all data elements in the current
//       FormatterOctal instance to corresponding data elements
...
//
//  err                 error
//     - If all data elements in the current FormatterOctal
//       instance are equal to all corresponding data elements in
//       'incomingIFormatter', this return parameter will be set to
//       'nil'.
//
...
//       will be returned.
//
func (fmtOctal *FormatterOctal) EqualINumStrFormatter(
	incomingIFormatter INumStrFormatter,
	ePrefix *ErrPrefixDto) (
	isEqual bool,
	err error) {
	...
	var incomingFormatterOctal *FormatterOctal

	incomingFormatterOctal,
		isEqual = incomingIFormatter.(*FormatterOctal)
...
// GetNumericSeparators - Returns the NumStrIntSeparatorsDto
...
//
//       The NumericSeparators object is used to specify the
//       separator characters which will be included in number
//       string text displays.
//
//        type NumericSeparators struct {
...
//       error message.
//
func (fmtOctal *FormatterOctal) GetNumericSeparators(
	ePrefix *ErrPrefixDto) (
	NumericSeparators,
	error) {
	...
	return fmtOctal.numericSeparators.CopyOut(
		ePrefix.XCtx(
			"fmtOctal"))
}
...
//       error message.
//
func (fmtOctal *FormatterOctal) SetNumericSeparators(
	numericSeparators NumericSeparators,
	ePrefix *ErrPrefixDto) error {
	...
	err := numericSeparators.IsValidInstanceError(
		ePrefix.XCtx(
			"numericSeparators"))
	...
	err =
		fmtOctal.numericSeparators.CopyIn(
			&numericSeparators,
			ePrefix.XCtx(
				"numericSeparators->"+
					"fmtOctal.numericSeparators"))
