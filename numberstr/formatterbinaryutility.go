...
// member variable data values for the FormatterBinary input
// parameter, 'formatterBinary'. The other input parameters
// represent the minimum information required to configure a
// FormatterBinary object. Default values are used to supplement
