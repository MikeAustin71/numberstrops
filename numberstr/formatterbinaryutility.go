...
// 'formatterBinary'. The other input parameters represent the
// minimum information required to configure a FormatterBinary
...
//       error message.
//
func (fmtBinaryUtil *formatterBinaryUtility) setBasic(
	formatterBinary *FormatterBinary,
	decimalSeparatorChars string,
	thousandsSeparatorChars string,
	turnOnIntegerDigitsSeparation bool,
...
// data values for the FormatterBinary input parameter,
// 'formatterBinary'. The other input parameters represent the
// minimum information required to configure a FormatterBinary
// object. Default values are used to supplement these input
// parameters.
...
//
// This method differs from method
// formatterCurrencyUtility.setBasic() in that this method accepts
