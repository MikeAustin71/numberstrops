...
// data elements in the current FormatterSciNotation instance.
//
// If the INumStrFormatter object is not of type
// FormatterSciNotation, this method will return an error and set
...
//  incomingIFormatter  INumStrFormatter
//     - This method will compare all data elements in the current
//       FormatterSciNotation instance to corresponding data
...
//       FormatterSciNotation instance are equal to all
...
//
//  err                 error
//     - If all data elements in the current FormatterSciNotation
//       instance are equal to all corresponding data elements in
...
//       will be returned.
//
func (fmtSciNotation *FormatterSciNotation) EqualINumStrFormatter(
	incomingIFormatter INumStrFormatter,
	ePrefix *ErrPrefixDto) (
	isEqual bool,
	err error) {
	...
	var incomingFmtSciNotation *FormatterSciNotation

	incomingFmtSciNotation,
		isEqual = incomingIFormatter.(*FormatterSciNotation)
	...
	isEqual,
		err = formatterSciNotationElectron{}.ptr().
		equal(
			fmtSciNotation,
			incomingFmtSciNotation,
			ePrefix.XCtx("fmtSciNotation vs "+
